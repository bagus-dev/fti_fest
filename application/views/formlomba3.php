...
<form method="post" id="form_file" enctype="multipart/form-data">
    <div class="custom-file">
        <input type="file" name="abstrak" id="customFile2" class="custom-file-input" accept=".pdf">
    ...
    <div class="form-group">
        <br>
        <button class="btn btn-primary" id="submit_file" type="button">Kirim File Abstrak</button>
    </div>
</form>
