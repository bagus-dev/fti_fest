...
<form method="post" id="form_lomba">
    ...
    <div class="form-group">
        ...
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="apps" id="apps1" class="custom-control-input" value="1" checked>
            <label for="apps1" id="label1" class="custom-control-label tentang">Mobile Apps</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="apps" id="apps2" class="custom-control-input" value="2">
            <label for="apps2" id="label2" class="custom-control-label tentang">Web Apps</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" name="apps" id="apps3" class="custom-control-input" value="3">
            <label for="apps3" id="label3" class="custom-control-label tentang">IOT</label>
        </div>
    </div>
    <div class="form-group">
